...
void abstr_emp::SetAll()
{
    ...
    using std::cin;
    using std::endl;
    if(_kbhit())  // determine whether the buffer is empty
    {
        while(cin.get()!='\n')
            continue;
    }
...
void abstr_emp::ReadAll(std::istream &fin)
{
    fin >> fname;
    fin >> lname;
    fin >> job;
...
void employee::ReadAll(std::istream &fin)
{
...
void manager::ReadAll(std::istream &fin)
{
    abstr_emp::ReadAll(fin);
    fin >> inchargeof;
}
...
void fink::ReadAll(std::istream &fin)
{
    abstr_emp::ReadAll(fin);
    fin >> reportsto;
}
...
void highfink::ReadAll(std::istream &fin)
{
    manager::ReadAll(fin);
    fin >> ReportsTo();
}
